...
Automatically selects which item is being weighed for its price tag through an AI model. The model chooses the matching fruit from a list of fruits in stock.
